...
query_dim_artist_name_generator = '''
    ...
    ON tda.artist_id = dan.artist_id
...
# query_dim_artist_name = '''select tda.artist_id, tda.artist_name
# from temp_dim_artist_name_table tda
# inner join dim_artist_name dan
# on tda.artist_id = dan.artist_id
# where dan.artist_id is null
# '''
...
#         .mode("overwrite") \
#         .save()
# insert_into_db(dim_artist_name_generator_df,"dim_artist_name_generator")
